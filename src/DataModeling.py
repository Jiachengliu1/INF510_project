...
def DataModeling():
    ...
    # Combine SF and PF as F, SG and PG as G
    ...
    #FGA_df.info()
    # Drop additional columns after cleaning
    ...
    result_dfs = [position_avgFGA_df, position_avgUSG_df, position_avgsalary_df, position_sumdraft_df]
